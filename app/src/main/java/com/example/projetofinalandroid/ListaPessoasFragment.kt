...
class ListaPessoasFragment : Fragment(), LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private var adapterPessoas : AdapterPesspas? = null
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_pessoas_lista, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)

        val recyclerViewPessoas = view.findViewById<RecyclerView>(R.id.recyclerViewMarcacoes)
        adapterPessoas= AdapterPesspas(this)
    ...
    fun navegaNovaMarcacoes(){
        findNavController().navigate(R.id.action_Lista_MarcacoesFragment_to_novaPessoaFragment)
    }
    ...
    fun processaOpcaoMenu(item: MenuItem): Boolean {
        when (item.itemId) {
            R.id.action_nova_pessoa -> navegaNovaMarcacoes()
            R.id.action_eliminar_Pessoa -> navegaEliminarMarcacoes()
            R.id.action_editar_pessoa -> navegaAlterarMarcacoes()
            else -> return false
        }
        return true
    }
